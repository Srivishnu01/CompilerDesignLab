...
=M[1]['+'].type=M[1]['-'].type=M[8]['+'].type=M[8]['-'].type=M[8][')'].type=M[3]['*'].type=M[3]['/'].type=M[10]['*'].type=M[10]['/'].type=shift;
...
=M[3]['$'].type=M[5]['$'].type=M[6]['$'].type=M[9]['$'].type=M[10]['$'].type=M[11]['$'].type=reduce;

M[0]['E'].type=M[0]['F'].type=M[0]['T'].type=M[2]['F'].type=M[2]['T'].type=M[4]['F'].type=M[7]['E'].type=M[7]['F'].type=M[7]['T'].type=go_to;
M[1]['$'].type=accept;

M[1]['+'].val=2;	M[3]['+'].val=5;	M[3]['+'].proj=0;   M[3]['-'].val=5;	M[3]['-'].proj=0;	M[5]['+'].val=20;	M[5]['+'].proj=0;   M[5]['-'].val=20;	M[5]['-'].proj=0;
M[6]['+'].val=6;	M[6]['+'].proj=0;   M[6]['-'].val=6;	M[6]['-'].proj=0;	M[8]['+'].val=2;
...
M[3]['*'].val=4;	M[5]['*'].val=20;	M[5]['/'].proj=0;	M[6]['*'].val=6;	M[6]['/'].proj=0;	M[9]['*'].val=6;	M[9]['/'].proj=1;	M[10]['*'].val=4;
M[11]['*'].val=20;	M[11]['/'].proj=1;  M[5]['*'].proj=0;	M[6]['/'].val=6;	M[6]['*'].proj=0;	M[9]['/'].val=6;	M[9]['*'].proj=1;	M[11]['/'].val=20;	M[11]['*'].proj=1;
